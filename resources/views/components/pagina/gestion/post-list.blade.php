...
<div class="sm:px-1 lg:px-8">
    ...
    <div class="grid grid-cols-12 w-full border-b py-4 items-center">
        ...
        <div class="col-span-3 justify-center flex flex-col md:flex-row gap-y-1 gap-x-1">
            ...
            <a class='py-2 px-4 text-sm rounded-lg bg-red-500 text-white cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-red-700' href="{{ route('post.edit', $post->id) }}">{{ __('Delete') }}</a>
